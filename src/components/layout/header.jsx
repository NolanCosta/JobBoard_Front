        ...
        <div>
            ...
            <div className="navbar">
                ...
                <div className="menu">
                    ...
                    <NavLink className={({ isActive }) => isActive ? 'menu-button' : ''} to="/jobs">Mes emplois</NavLink>

                    <NavLink className={({ isActive }) => isActive ? 'menu-button' : ''} to="/company">Mes entreprises</NavLink >
